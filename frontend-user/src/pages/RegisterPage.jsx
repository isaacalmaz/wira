    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 bg-white">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <input type="password" placeholder="Password (Min. 6 Karakter)" className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary" required minLength={6} onChange={e=>setForm({...form, password: e.target.value})} />
          <input type="password" placeholder="Konfirmasi Password" className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary" required minLength={6} onChange={e=>setForm({...form, confirm: e.target.value})} />
