...
2. Klik **New query**.
3. Buka folder `migrations/` di project Wira Anda. Jalankan file-filenya **berurutan sesuai nomor** (`0001_...sql`, `0002_...sql`, dst.): copy isi satu file, paste ke SQL Editor Supabase, lalu klik **Run** (tombol hijau).
4. Baca `migrations/README.md` dulu — di sana dijelaskan urutan, ketergantungan, dan catatan tiap file.
