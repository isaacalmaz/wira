-- =============================================================================
-- Migration 0013: PostGIS extension + operational_zones table + geofencing RPC
-- Source: setup_geofencing.sql (repo root)
-- Original creation date (git history, first commit): 2026-09-12
-- =============================================================================
-- Depends on public.feature_flags (0003) for the data migration step, and
-- ideally on 0012 having successfully inserted a region='operational_zones'
-- row first (if 0012 errored/was skipped, step 4 below is simply a no-op —
-- non-fatal, but operational_zones will be seeded empty).
-- =============================================================================
