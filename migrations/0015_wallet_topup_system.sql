-- =============================================================================
-- Migration 0015: Wallet balance, top-up requests, transactions ledger + RPCs
-- Source: setup_wallet.sql (repo root)
-- Original creation date (git history, first commit): 2026-09-12
-- =============================================================================
-- Depends on public.users from 0001. Note that public.transactions is
-- created here (step 2b) — a table also referenced conceptually by
-- backend/database/schema.sql's fictional `wallets`-keyed transactions
-- table, but this live version keys transactions directly off user_id, no
-- separate wallets table exists on the live schema.
-- =============================================================================
